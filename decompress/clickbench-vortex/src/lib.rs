...
struct State {
    batch: ArrowArray,
    buffer_arrays: [Vec<WasmPtr>; 6],
    inner_batches: [ArrowArray; 6],
    children: [WasmPtr; 6],
...
impl State {
    pub fn new() -> Self {
        Self {
            ...
            buffer_arrays: rep6!(vec![WasmPtr::NULL, WasmPtr::NULL]),
            inner_batches: rep6!(ArrowArray::empty()),
            children: [WasmPtr::NULL; 6],
            top_level_buffer_array: [WasmPtr::NULL],
            owned_buffers: Vec::with_capacity(3 * 6),
